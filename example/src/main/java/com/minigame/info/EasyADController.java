...
import com.minigame.info.custom.HuaWeiSplashAdapter;
import com.minigame.info.custom.XiaoMiSplashAdapter;
...
public class EasyADController {
    ...
    public EasyADController(Activity activity, Handler handler) {
        mActivity = activity;
...
//        easyInterstitial.setCsjNew(false);
    ...
    public EasyAdRewardVideo initReward(String jsonFileName) {
        ...
        EARewardVideoListener listener = new EARewardVideoListener() {
            ...
            @Override
            public void onAdClose() {
                logAndToast(mActivity, "广告关闭2222");
            }

            @Override
            public void onAdReward() {
                logAndToast(mActivity, "激励发放3333");
