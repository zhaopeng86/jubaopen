...
import com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapperImpl;
import com.minigame.info.listvideo.video_player_manager.ui.ReadyForPlaybackIndicator;
import com.minigame.info.listvideo.video_player_manager.ui.ScalableTextureView;
import com.minigame.info.listvideo.video_player_manager.utils.HandlerThreadExtension;
import com.minigame.info.listvideo.video_player_manager.utils.Logger;
...
public class VideoPlayerView extends ScalableTextureView
        ...
        com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.MainThreadMediaPlayerListener,
        com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.VideoStateListener {
     ...
     */
    private com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper mMediaPlayer;
    ...
    private com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.VideoStateListener mVideoStateListener;
    private SurfaceTextureListener mLocalSurfaceTextureListener;

    private AssetFileDescriptor mAssetFileDescriptor;
    private String mPath;

    private final com.minigame.info.listvideo.video_player_manager.ui.ReadyForPlaybackIndicator mReadyForPlaybackIndicator = new ReadyForPlaybackIndicator();

    private final Set<com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.MainThreadMediaPlayerListener> mMediaPlayerMainThreadListeners = new HashSet<>();

    public com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.State getCurrentState() {
    ...
    private void notifyOnVideoStopped() {
        ...
        List<com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.MainThreadMediaPlayerListener> listCopy;
        synchronized (mMediaPlayerMainThreadListeners){
            listCopy = new ArrayList<>(mMediaPlayerMainThreadListeners);
        }
        for (com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.MainThreadMediaPlayerListener listener : listCopy){
    ...
    public void setOnVideoStateChangedListener(com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.VideoStateListener listener) {
    ...
    public void addMediaPlayerListener(com.minigame.info.listvideo.video_player_manager.ui.MediaPlayerWrapper.MainThreadMediaPlayerListener listener) {
        synchronized (mMediaPlayerMainThreadListeners){
