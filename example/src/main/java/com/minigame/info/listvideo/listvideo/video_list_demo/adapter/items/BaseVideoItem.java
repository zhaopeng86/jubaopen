package com.minigame.info.listvideo.listvideo.video_list_demo.adapter.items;
...
import com.minigame.info.listvideo.video_player_manager.manager.VideoItem;
import com.minigame.info.listvideo.video_player_manager.manager.VideoPlayerManager;
import com.minigame.info.listvideo.video_player_manager.meta.CurrentItemMetaData;
...
public abstract class BaseVideoItem implements VideoItem, ListItem {
    ...
    public View createView(ViewGroup parent, int screenWidth) {
        ...
        videoViewHolder.mPlayer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                videoViewHolder.mPlayer.centralizeContent();
                Toast.makeText(parent.getContext(),"asdfafaf",Toast.LENGTH_LONG).show();
            }
        });
