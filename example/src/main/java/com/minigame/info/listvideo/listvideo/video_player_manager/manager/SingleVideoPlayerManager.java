package com.minigame.info.listvideo.listvideo.video_player_manager.manager;

import android.content.res.AssetFileDescriptor;

import com.minigame.info.listvideo.video_player_manager.Config;
import com.minigame.info.listvideo.video_player_manager.MessagesHandlerThread;
import com.minigame.info.listvideo.video_player_manager.PlayerMessageState;
import com.minigame.info.listvideo.video_player_manager.SetNewViewForPlayback;
...
import com.minigame.info.listvideo.video_player_manager.player_messages.ClearPlayerInstance;
import com.minigame.info.listvideo.video_player_manager.player_messages.CreateNewPlayerInstance;
import com.minigame.info.listvideo.video_player_manager.player_messages.PlayerMessage;
import com.minigame.info.listvideo.video_player_manager.player_messages.Prepare;
import com.minigame.info.listvideo.video_player_manager.player_messages.Release;
import com.minigame.info.listvideo.video_player_manager.player_messages.Reset;
import com.minigame.info.listvideo.video_player_manager.player_messages.SetAssetsDataSourceMessage;
import com.minigame.info.listvideo.video_player_manager.player_messages.SetUrlDataSourceMessage;
import com.minigame.info.listvideo.video_player_manager.player_messages.Start;
import com.minigame.info.listvideo.video_player_manager.player_messages.Stop;
...
/**
 * This implementation of {@link com.minigame.info.listvideo.video_player_manager.manager.VideoPlayerManager} is designed to manage a single video playback.
...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
     ...
     * then it calls {@link com.minigame.info.listvideo.video_player_manager.manager.PlayerItemChangeListener#onPlayerItemChanged(MetaData)}}
     * To notify that player was switched.
     */
    private final com.minigame.info.listvideo.video_player_manager.manager.PlayerItemChangeListener mPlayerItemChangeListener;

    private VideoPlayerView mCurrentPlayer = null;
    private PlayerMessageState mCurrentPlayerState = PlayerMessageState.IDLE;

    public SingleVideoPlayerManager(com.minigame.info.listvideo.video_player_manager.manager.PlayerItemChangeListener playerItemChangeListener) {
